...
<section style="color:white; font-family:sans-serif" class="py-5">
  ...
  <div class="container">
     ...
     <h2 style="text-align:center;">Wypożycz coś dla siebie!</h2>
      <br />
      <asp:GridView style="color:white; font-family:sans-serif" cssClass="table" ID="gvGry" runat="server"></asp:GridView>
  </div>
...
<section class="py-5">
  ...
  <div class="container" >
        ...
        <div>
    <div class="container">
      <asp:DropDownList ID="listg" Width="4%" CssClass="form-control" runat="server"></asp:DropDownList>
        <div>
