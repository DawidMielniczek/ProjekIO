<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KlientDostepne.aspx.cs" Inherits="WypożyczalniaSprzętuFilmowego.Strony.Uzytkownik.KlientDostepne" %>
...
<section style="background-color:black" class="py-5">
  ...
  <div class="container">
     ...
     <h2 style="text-align:center; color:white; font-weight:bold">Nasz dostępny sprzęt</h2>
      <br />
      <asp:GridView style="color:white; font-family:sans-serif" ID="gvGry" cssClass="table" runat="server"></asp:GridView>
  </div>
    </form>
</section>
</body>
